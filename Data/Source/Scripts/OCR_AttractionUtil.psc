Scriptname OCR_AttractionUtil extends Quest  
...
float Function CalculateNPCAttraction(actor actor1)
    ...
    float AttractivenessBase = OCR_AttractivenessBase.GetValue()
...
Function InitialAttractivenessQuestionnaire()
    ...
    OCR_BaseAttractiveness_Start.show()
    Int iChoice0 = OCR_BaseAttractiveness_Physically.show()
        if iChoice0 == 0
            attPhysical = 6
        elseIf iChoice0 == 1
            attPhysical = 12
    ...
    Int iChoice1 = OCR_BaseAttractiveness_Socially.show()
        if iChoice1 == 0
            attSocial = 4
        elseIf iChoice1 == 1
            attSocial = 8
    ...
    OCR_AttractivenessBase.setValue(attFinal)
...
int Function GetAttractivenessThreshold(Actor actor1)
    ...
    if actor1.IsInFaction(OCR_SocialClass_Other)
        MiscUtil.PrintConsole("GetNPCAttraction: NPC social class is OCR_SocialClass_Other")
        if actor1IsFemale == 1
            threshold = 70
        else
            threshold = 50
    ...
    elseif actor1.IsInFaction(OCR_SocialClass_CitizenNoble)
        MiscUtil.PrintConsole("GetNPCAttraction: NPC social class is OCR_SocialClass_CitizenNoble")
        if actor1IsFemale == 1
            threshold = 80
        else
            threshold = 60
    ...
    elseif actor1.IsInFaction(OCR_SocialClass_SoldierOrGuard)
        MiscUtil.PrintConsole("GetNPCAttraction: NPC social class is OCR_SocialClass_SoldierOrGuard")
        if actor1IsFemale == 1
            threshold = 60
        else
            threshold = 40
    ...
    elseif actor1.IsInFaction(OCR_SocialClass_CitizenMiddle)
        MiscUtil.PrintConsole("GetNPCAttraction: NPC social class is OCR_SocialClass_CitizenMiddle")
        if actor1IsFemale == 1
            threshold = 60
        else
            threshold = 40
    ...
    elseif actor1.IsInFaction(OCR_SocialClass_CitizenLow)
        MiscUtil.PrintConsole("GetNPCAttraction: NPC social class is OCR_SocialClass_CitizenLow")
        if actor1IsFemale == 1
            threshold = 50
        else
            threshold = 24
    ...
    elseif actor1.IsInFaction(OCR_SocialClass_CitizenLowest)
        MiscUtil.PrintConsole("GetNPCAttraction: NPC social class is OCR_SocialClass_CitizenLowest")
        if actor1IsFemale == 1
            threshold = 25
        else
            threshold = 15
        ...
        elseif (actor1.GetFactionRank(JobJarlFaction) >= -1) || (actor1.GetFactionRank(JobJusticiar) >= -1) || (actor1.GetFactionRank(JobOrcChiefFaction) >= -1) || (actor1.GetFactionRank(JobHousecarlFaction) >= -1) || (actor1.GetFactionRank(JobStewardFaction) >= -1)
            MiscUtil.PrintConsole("GetNPCAttraction: Assigned social class OCR_SocialClass_CitizenNoble")
        ...
        elseif (actor1.GetFactionRank(JobFarmerFaction) >= -1) || (actor1.GetFactionRank(JobAnimalTrainerFaction) >= -1) || (actor1.GetFactionRank(JobFletcherFaction) >= -1) || (actor1.GetFactionRank(JobInnServer) >= -1) || (actor1.GetFactionRank(JobHostlerFaction) >= -1) || (actor1.GetFactionRank(JobRentRoomFaction) >= -1)
            MiscUtil.PrintConsole("GetNPCAttraction: Assigned social class OCR_SocialClass_CitizenLow")
        ...
        elseif  actor1Class == GuardOrc1H || actor1Class == GuardOrc2H || actor1Class == SoldierImperialNotGuard || actor1Class == SoldierSonsSkyrimNotGuard
            MiscUtil.PrintConsole("GetNPCAttraction: Assigned social class OCR_SocialClass_SoldierOrGuard")
        ...
        elseif actor1Class == Citizen || (actor1.GetFactionRank(JobApothecaryFaction) >= -1) || (actor1.GetFactionRank(JobBardFaction) >= -1) || (actor1.GetFactionRank(JobBlacksmithFaction) >= -1) || (actor1.GetFactionRank(JobCarriageFaction) >= -1) || (actor1.GetFactionRank(JobCourtWizardFaction) >= -1) || (actor1.GetFactionRank(JobFenceFaction) >= -1) || (actor1.GetFactionRank(JobInnkeeperFaction) >= -1) || (actor1.GetFactionRank(JobJewelerFaction) >= -1) || (actor1.GetFactionRank(JobMerchantFaction) >= -1) || (actor1.GetFactionRank(JobMiscFaction) >= -1) || (actor1.GetFactionRank(JobPriestFaction) >= -1) || (actor1.GetFactionRank(JobGuardCaptainFaction) >= -1)
            MiscUtil.PrintConsole("GetNPCAttraction: Assigned social class OCR_SocialClass_CitizenMiddle")
            ...
            MiscUtil.PrintConsole("GetNPCAttraction: NPC has not matched any conditions. Assigned social class OCR_SocialClass_Other")
